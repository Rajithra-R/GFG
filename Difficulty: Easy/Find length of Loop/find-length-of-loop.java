...
class Solution {
    ...
    public int countNodesinLoop(Node head) {
        ...
        while (fast != null && fast.next != null) {
            ...
            if (slow == fast) {
                return countLoopLength(slow);  // Calculate and return loop length
            }
        }
    ...
    private int countLoopLength(Node nodeInLoop) {
        ...
        int count = 1;  // Initialize count to 1 to include the first node in the loop
        
        // Traverse the loop until we come back to the starting point
